...
The complete project overview and code explanation is available in the recorded video below:

**[Watch the Recorded Project Video](https://drive.google.com/file/d/1LcDJvVogmcd9oY34Rz--jG-9cauUJA96/view?usp=sharing)**

The video explains the project workflow, including dataset loading, preprocessing, EDA, baseline ANN, activation function comparison, weight initialization, loss function comparison, Batch Normalization, optimizer comparison, learning-rate experiments, final ANN, evaluation, and model saving.
